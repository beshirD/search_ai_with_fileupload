...
export function OrganizationListPage(props: OrganizationListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getOrganizations({
        relations: ['user', 'documentation.count', 'invitation.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('user', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('documentation', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'documentation',
          header: 'Documentation',
          accessorKey: 'documentation',
          cell: ({ row: { original: record } }: any) => record?._count?.documentation,
        }
      : null,
