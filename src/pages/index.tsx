...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`documentation-search-ai`}</title>

        <meta
          name="description"
          content="Experience efficiency with Documentation-Search-AI: an intelligent search platform that learns from documentation and delivers precise answers. User-friendly interface, seamless query entry, and intuitive answer display."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1686191567720-68f6981e9ad4?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxBSSUyMHNlYXJjaHxlbnwwfHx8fDE2OTM4NTY4OTh8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience efficiency with Documentation-Search-AI: an intelligent search platform that learns from documentation and delivers precise answers. User-friendly interface, seamless query entry, and intuitive answer display.`}
            </Text>
            <Box
